...
class CaseRepository(Protocol):
    ...
    async def assign_case(self, case_id: UUID, actor_id: UUID, target_manager_actor_id: UUID) -> bool: ...
    async def unassign_case(self, case_id: UUID, actor_id: UUID) -> bool: ...

    async def escalate_to_owner(self, case_id: UUID, actor_id: UUID) -> bool: ...
