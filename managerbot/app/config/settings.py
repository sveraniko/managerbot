...
class Settings(BaseSettings):
    ...
    queue_page_size: int = Field(default=5, ge=1, le=50)
    notification_poll_seconds: int = Field(default=20, ge=1, le=300)
    notification_dedupe_ttl_seconds: int = Field(default=3600, ge=30, le=86400)
    ...
    ai_max_input_chars: int = Field(default=6000, ge=500, le=24000)
    ai_max_thread_entries: int = Field(default=6, ge=1, le=30)
    ai_max_internal_notes: int = Field(default=3, ge=0, le=20)
    ai_max_output_tokens: int = Field(default=500, ge=100, le=4000)
    ai_include_internal_notes: bool = Field(default=True)
    ai_recommender_enabled: bool = Field(default=False)
    ai_recommender_max_output_tokens: int = Field(default=700, ge=100, le=4000)
    ai_cache_ttl_seconds: int = Field(default=120, ge=0, le=7200)
    ai_min_confidence_for_draft_adoption_warning: float = Field(default=0.65, ge=0.0, le=1.0)
